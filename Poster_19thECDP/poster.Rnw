...
%%% Authors %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
{
	\vspace{1em} 
	\textcolor{white}{
	Zandonella Callegher C., Marci T. \& Altoè G.\\
...
\begin{itemize}[leftmargin=*]
  \item{\textbf{Attachment relationships} play a key role in children’s socioemotional adjustment (Cassidy \& Shaver, 2016)}
...
\begin{itemize}[leftmargin=*]
  ...
  \item{Simultaneously compare diffrent theoretical prospectives within a Bayesian model comparison approach.}
\end{itemize}
}
...
\textbf{Participants}: 166 children (mean age = 9 years and SD = 7 months, 54\% girls) were recruited from Italian primary schools.\par
...
\begin{itemize}[leftmargin=*]
  ...
  \item{\textbf{Strengths \& Difficulties Questionnaire} (SDQ; Goodman, 2001); School theachers  evaluated children internalizing and  externalizing problems.}
...
\textbullet\ \textbf{Internalizing Problems:} boys have more problems than girls. Greater discrepancy between the maternal and paternal levels of security are assocaited to more problems. 
\end{minipage}
%%%%%%
\hfill
\begin{minipage}{.45\linewidth}
\textbullet\ \textbf{Externalizing Problems:} boys have more problems than girls. Younger childer have more problems than older children. Low levels of maternal security are associated to more problems.
\end{minipage}
\hspace{2em}
%%%%%%
